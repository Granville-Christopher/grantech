...
const Footer: React.FC = () => {
  return (
    <footer className="bg-black relative z-20 border-t-2 border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 md:py-16">
          ...
          <div className="border-t border-b border-white/10 py-8 mb-8">
            <div className="flex flex-col items-center space-y-6">
              <div className="text-center">
                <p className="text-xs md:text-sm font-semibold text-white/60 uppercase tracking-wider mb-4">
                  Connect With Us
                </p>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mb-8">
            <a
              href="#"
              className="text-sm md:text-base text-white/70 hover:text-white font-medium transition-colors duration-300 relative group"
            >
              Privacy Policy
