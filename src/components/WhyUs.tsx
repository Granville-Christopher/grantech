    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2
            className={`text-2xl md:text-4xl font-extrabold mb-4 text-gray-900 animate-slide-in`}
          >
            The GranTech Difference
          </h2>
          <p className="text-base md:text-lg text-gray-700 max-w-3xl mx-auto animate-slide-in animate-delay-1">
            We've moved beyond simple development. Our process is centered
            on **Security, Scalability, and Adaptive Design**.
          </p>
        </div>
